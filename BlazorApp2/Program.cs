...
using BlazorApp2.Controllers.AdminPanelControllers;
...
builder.Services.AddScoped<AdminPanelController>();
...
app.MapGet("/home", (ClaimsPrincipal User) =>
{
